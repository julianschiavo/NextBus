...
// https://github.com/apple/swift-package-manager/blob/swift-5.1-branch/Sources/Basic/OrderedSet.swift
...
public struct OrderedSet<E: Hashable>: Equatable, Collection {
    ...
    /// Adds the contents of an array to the ordered set.
...
extension OrderedSet where Element: Identifiable {
    mutating func removeDuplicates() {
        array.removeDuplicates()
        set = Set(array)
    }
    
    func removingDuplicates() -> OrderedSet<Element> {
        var copy = self
