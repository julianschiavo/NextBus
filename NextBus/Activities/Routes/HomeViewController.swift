        ...
        init(tableView: UITableView) {
            super.init(tableView: tableView) { tableView, indexPath, item -> UITableViewCell? in
                ...
                case let .favorite(route, direction, stop):
                    ...
                    cell.setup(route: route, direction: direction, origin: stop.localizedName, isFavorite: true)
                    return cell
...
//                }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch item {
        case let .favorite(route, direction, stop):
            let viewController = UIHostingController(rootView: StopDetail(route: route, stop: stop))
