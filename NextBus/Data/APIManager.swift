...
//    // MARK: - Routes
//    
//    func fetchRoutes(companyID: CompanyID, route: String?, urlSession: URLSession, completion: @escaping (Result<[Route], Error>) -> Void)
//    
//    // MARK: - Stops
//    
//    func updateStops(for route: Route, includingCached: Bool, urlSession: URLSession, completion: @escaping (Error?) -> Void)
//    func fetchStops(for route: Route, in direction: Direction, urlSession: URLSession, completion: @escaping (Result<[Stop], Error>) -> Void)
//    
//    // MARK: - ETAs
//    
//    func fetchETA(for route: Route, in direction: Direction, stop: Stop, urlSession: URLSession, completion: @escaping (Result<[ETA], Error>) -> Void)
//}
//
//class APIManager {
//    
...
//    }
//
//    func cache(_ routes: [Route], for companyID: CompanyID, fetchPrices shouldFetchPrices: Bool = true) {
...
//    }
//
//    private func fetchRoutes(for companyID: CompanyID, route: String? = nil, priority: Priority, completion: @escaping (Result<[Route], Error>) -> Void) {
//        priority.queue.async {
...
//    }
//    
//    private func fetchPricesAndRecacheRoutes(routes: [Route], for companyID: CompanyID) {
...
//            self.cache(Array(updatedRoutes), for: companyID, fetchPrices: false)
//        })
//        
//        for route in routes {
//            group.enter()
...
//    }
//    
//    func cache(_ stops: [Stop], for route: Route, in direction: Direction) {
//        defer {
...
//    }
//    
//    fileprivate func cacheNameIndex(for stops: [Stop], route: Route, direction: Direction) {
//        let stopNameIndex = stops.map { $0.name.english.lowercased() + $0.name.simplifiedChinese.lowercased() + $0.name.traditionalChinese.lowercased() }.joined()
//
...
//    }
//
//    func fetchStops(for route: Route, in direction: Direction, priority: Priority, completion: @escaping (Result<[Stop], Error>) -> Void) {
//        if CompanyID.nwfbctbIDs.contains(route.companyID) {
...
//    // MARK: - ETA
//
//    func fetchETA(for route: Route, in direction: Direction, stop: Stop, priority: Priority, completion: @escaping (Result<[ETA], Error>) -> Void) {
//        if CompanyID.nwfbctbIDs.contains(route.companyID) {
