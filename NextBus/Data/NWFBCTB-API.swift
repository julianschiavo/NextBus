...
//    // MARK: - Routes
//    
//    func fetchRoutes(companyID: CompanyID, route: String? = nil, urlSession: URLSession, completion: @escaping (Result<[Route], Error>) -> Void) {
...
//            decoder.dateDecodingStrategy = .iso8601
//            do {
//                let rawRoute = try decoder.decode(NWFBCTBModels.RawRoute.self, from: data)
//                let routes = rawRoute.routes
//                APIManager.shared.cache(Array(routes), for: companyID)
//                
//                APIManager.request(ofType: type, didChangeStatus: .decodeSuccessful)
//                completion(.success(Array(routes)))
//            } catch {
...
//    }
//    
//    private func fetchStops(route: Route, direction: Direction, urlSession: URLSession, completion: @escaping (Result<[Stop], Error>) -> Void) {
...
//    }
//    
//    private func fetchStops(unknownStops: [NWFBCTBModels.UnknownStop], urlSession: URLSession, completion: @escaping (Result<[Stop], Error>) -> Void) {
//        var stops = [Stop]()
//        var error: Error?
//        
//        let group = DispatchGroup()
...
//                }
//                completion(.success(sortedStops))
//            }
//        }
//    }
//    
//    private func fetchStop(unknownStop: NWFBCTBModels.UnknownStop, urlSession: URLSession, completion: @escaping (Result<Stop?, Error>) -> Void) {
//        let type = "FetchStop"
//        
...
//                
//                APIManager.request(ofType: type, didChangeStatus: .decodeSuccessful)
//                completion(.success(rawStop.toModel()))
//            } catch {
//                APIManager.request(ofType: type, didChangeStatus: .decodeFailed(url, error))
//                
//                switch error {
...
//    }
//    
//    private func fetchUnknownStops(route: Route, direction: Direction, urlSession: URLSession, completion: @escaping (Result<[NWFBCTBModels.UnknownStop], Error>) -> Void) {
//        let type = "FetchUnknownStops"
//        
//        let direction = NWFBCTBModels._Direction.from(direction)
